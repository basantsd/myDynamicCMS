...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p>Add a new form to your website</p>
        </div>
        ...
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="calculation-config-section" class="mb-3" style="display: none;">
                        ...
                        <textarea class="d-none" id="calculation_config" name="calculation_config">{{ old('calculation_config', '{}') }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="submit_button_text" class="form-label">Submit Button Text</label>
                        <input type="text" class="form-control @error('submit_button_text') is-invalid @enderror" id="submit_button_text" name="submit_button_text" value="{{ old('submit_button_text', 'Submit') }}">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="send_email_notification" name="send_email_notification" value="1" {{ old('send_email_notification') ? 'checked' : '' }}>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="store_submissions" name="store_submissions" value="1" {{ old('store_submissions', true) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="enable_captcha" name="enable_captcha" value="1" {{ old('enable_captcha') ? 'checked' : '' }}>
